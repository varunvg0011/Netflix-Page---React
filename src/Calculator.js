...
class Calculator extends React.Component{
  ...
  CalculateExpression=(e)=>{
    ...
    if(number=="="){
      document.getElementById('outlined-basic').value = eval(document.getElementById('outlined-basic').value)
    }
    document.getElementById('outlined-basic').value +=number */
      ...
      <Grid container spacing={.5}>
        ...
        <Grid container spacing={1}>
          <Grid item xs={3} sm={1} lg={.6} md={1} xl={.5} >           
              <Button onClick={this.CalculateExpression} value="1" variant="contained">1</Button>                             
          </Grid>
